...
- (NSURLSessionTask *)sessionTaskForRequest:(RCSRequest *)request error:(NSError **)error {
    RCSHTTPRequestMethod httpMethod = request.httpMethod;
...
- (AFHTTPRequestSerializer *)requestSerializerForRequest:(RCSRequest *)request {
    ...
    if (request.httpMethod == RCSHTTPRequestMethodPOST && [contentType containsString:@"application/json"]) {
...
- (NSString *)httpMethodStr:(RCSHTTPRequestMethod)httpMethod {
